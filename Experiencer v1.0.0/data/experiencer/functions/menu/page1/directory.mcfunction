...
execute if score @s selection_EXr matches 16 run scoreboard players set @s val_lvls_EXr 2147483647
execute if score @s selection_EXr matches 1.. run function experiencer:xp/take