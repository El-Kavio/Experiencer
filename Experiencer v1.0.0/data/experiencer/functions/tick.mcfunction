...
execute as @a[scores={on_death_EXr=1..}] if score .global 1_10_lose_cEXr matches 0 run scoreboard players set @s on_death_EXr 0
execute as @a[scores={on_death_EXr=1..}] if score .global 1_10_lose_cEXr matches 1 run function experiencer:config/1_10_xp_lose