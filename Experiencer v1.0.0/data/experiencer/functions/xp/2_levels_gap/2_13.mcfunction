execute if score @s stored_pts_EXr matches 8192.. run function experiencer:xp/2_xp/2_13
execute if score @s stored_pts_EXr matches 4096..8191 run function experiencer:xp/2_xp/2_12
execute if score @s stored_pts_EXr matches 2048..4095 run function experiencer:xp/2_xp/2_11
execute if score @s stored_pts_EXr matches 1024..2047 run function experiencer:xp/2_xp/2_10
